        ...
        if (taskData.total > 0) {
            ...
            rows = tasks.map((entry: any) => {
                ...
                return {
                    ...
                    patientBsn: patientIdentifier && patientIdentifier.value || "Unknown",
                    patientLastname: patientName && patientName.given[0] || "Unknown",
                    patientSurname: patientName && patientName.family || "Unknown",
