...
type Provider interface {
	...
	Authenticator(ctx context.Context, resourceServerURL *url.URL, fn func(writer http.ResponseWriter, request *http.Request)) func(writer http.ResponseWriter, request *http.Request)
