...
type Provider interface {
	...
	HttpClient(ctx context.Context, tenantID string, serverIdentity fhir.Identifier) (*http.Client, error)
	...
	Identities(ctx context.Context, tenantID string) ([]fhir.Organization, error)
	CapabilityStatement(cp *fhir.CapabilityStatement, tenantID string) error
}
