...
// Source: careplancontributor/ehr/kafka_client.go
//
// Generated by this command:
//
//	mockgen -destination=careplancontributor/ehr/kafka_client_mock.go -package=ehr -source=careplancontributor/ehr/kafka_client.go
//
