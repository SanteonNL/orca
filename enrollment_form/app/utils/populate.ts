...
export async function populateQuestionnaire(
  ...
  if (
    ...
    console.log('No launch contexts, source queries, or questionnaire-level variables found.');
    return {
  ...
  if (!inputParameters) {
    console.log('No input parameters created.');
    return {
      populateSuccess: false,
      populateResult: null
    };
  ...
  // Perform population if parameters satisfy input parameters
  ...
  if (outputParameters.resourceType === 'OperationOutcome') {
    console.log('OperationOutcome received:', outputParameters);
    return {
      populateSuccess: false,
      populateResult: null
    };
  ...
  console.log('Population successful:', responseParameter.resource);
  return {
    populateSuccess: true,
    populateResult: {
      populated: responseParameter.resource,
