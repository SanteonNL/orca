...
func setupOrchestrator(t *testing.T, dockerNetworkName string, containerName string, tenant Tenant, cpsEnabled bool, fhirStoreURL string, questionnaireFhirStoreUrl string, allowUnmanagedFHIROperations bool) *url.URL {
	...
	req := testcontainers.ContainerRequest{
		...
		Env: map[string]string{
			...
			"ORCA_TENANT_" + tenant.ID + "_NUTSSUBJECT":         tenant.NutsSubject,
