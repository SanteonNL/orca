...
import {codingLabel, requiredCodingLabel, taskStatusLabel} from "@/app/utils/mapping";
...
export default function PatientDetails({task, patient}: PatientDetailsProps) {
    const serviceRequestCode = task.reasonCode?.coding?.[0];
    return (
        <div className="w-[568px] grid grid-cols-[1fr_2fr] gap-y-4">
            ...
            <StatusElement label="Diagnose" value={requiredCodingLabel(serviceRequestCode)}/>
