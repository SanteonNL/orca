...
describe('getLaunchableApps', () => {
    ...
    const mockScpClient = {search: mockSearchFn} as any;
    beforeEach(() => {
        jest.clearAllMocks();
    ...
    it('returns test app when patient viewer URL is available', async () => {
        const result = await getLaunchableApps(mockScpClient as any, mockOrganization);
    ...
    it('searches for endpoints when no test app URL is available', async () => {
        ...
        const result = await getLaunchableApps(mockScpClient, mockOrganization);
    ...
    it('handles organization identifier with special characters', async () => {
        ...
        await getLaunchableApps(mockScpClient, specialOrganization);
